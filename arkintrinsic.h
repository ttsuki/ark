/// @file
/// @brief	arkana::intrinsic
/// @author Copyright(c) 2021 ttsuki
/// Distributed under the Boost Software License, Version 1.0.
///         https://github.com/ttsuki/ark/

#pragma once
#ifndef ARKANA_INTRINSIC_H_INCLUDED
#define ARKANA_INTRINSIC_H_INCLUDED
...
{
    using intrinsic::memcpy;
    using intrinsic::memset;
    using intrinsic::load_u;
    using intrinsic::store_u;
    using intrinsic::bit_cast;
    using intrinsic::type_punning_cast;
    using intrinsic::secure_memzero;
    using intrinsic::secure_be_zero;

    using intrinsic::rotl;
    using intrinsic::rotr;
    using intrinsic::byteswap;
    using intrinsic::shld;
    using intrinsic::shrd;
}

namespace arkintrin = arkana::intrinsic;
